...
# This run will assemble only the 1st due to time problems with the first attempt
...
# Use --k-list 65
megahit -t 2 --kmin-1pass --k-list 65 \
...
-o /home/tola2495/GenomeAnalysisVT2022/analyses/02_dna_assembly/01_megahit/220409_RR4342129_dna_assembly.megahit_asm # 2 paired-end libraries

#megahit -t 2 --kmin-1pass --k-list 65 \
#-1 /home/tola2495/GenomeAnalysisVT202--k-list 652/data/trimmed_data/dna/RR4342133_1.paired.trimmed.fastq.gz \
#-2 /home/tola2495/GenomeAnalysisVT2022/data/trimmed_data/dna/RR4342133_2.paired.trimmed.fastq.gz \
#-o /home/tola2495/GenomeAnalysisVT2022/analyses/02_dna_assembly/01_megahit/TBD_RR4342133_dna_assembly.megahit_asm # 2 paired-end libraries
