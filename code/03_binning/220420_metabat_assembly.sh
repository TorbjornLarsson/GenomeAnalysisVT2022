...
# Call: metabat -i (contigs fasta infile) -a (coverage text file) -o (outdirectory) -t 2 -m 1500 -v --unbinned
...
-a /home/tola2495/GenomeAnalysisVT2022/analyses/02_dna_assembly/03_BBTools/220417_RR4342129_aln_cov.txt \
